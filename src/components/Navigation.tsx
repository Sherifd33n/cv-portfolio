            ...
            <button
              ...
              <div
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  activeSection === index
                    ? "bg-[#3713ec] scale-150 shadow-lg shadow-[#8B7355]/50"
                    : "bg-[#F5F3EF]/30 hover:bg-[#F5F3EF]/50"
                }`}
              />
              <span
                className={`absolute right-full mr-4 px-3 py-1 bg-[#3713ec] border border-[#0079ca] rounded text-sm font-mono whitespace-nowrap transition-all duration-300 ${
                  activeSection === index
